...
const userRoutes = require('./routes/userRoutes'); // Importar as rotas de autenticação
...
// Usar as rotas de cupons com proteção
app.use('/api/users', authMiddleware, userRoutes); // Aplica a proteção

// Usar as rotas de cupons com proteção
app.use('/api/public-coupons', couponRoutes); // Aplica a proteção

// Usar as rotas de cupons com proteção
app.use('/api/roles', authMiddleware, rolesRoutes); // Aplica a proteção

// Usar as rotas de cupons com proteção
app.use('/api/permissions', authMiddleware, permissionsRoutes); // Aplica a proteção
